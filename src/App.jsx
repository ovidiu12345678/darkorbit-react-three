...
const FUNDAL_JOC_FLOTA = "assets/fundal-flota-carmizie.png";
const FUNDAL_JOC_VERDANT = "assets/fundal-verdant-rubra.png";
...
const CORPURI_HARTA_FLOTA = "assets/corpuri-flota-carmizie-atlas.png";
const CORPURI_HARTA_VERDANT = "assets/corpuri-verdant-rubra-atlas.png";
...
const FUNDAL_MINI_FLOTA = FUNDAL_JOC_FLOTA;
const FUNDAL_MINI_VERDANT = FUNDAL_JOC_VERDANT;
...
const POZITIE_PORTAL_FLOTA_KHARON = [-COORDONATA_PORTAL_AETHER, 0, -COORDONATA_PORTAL_AETHER];
const POZITIE_PORTAL_FLOTA = [-COORDONATA_PORTAL_AETHER, 0, -COORDONATA_PORTAL_AETHER];
const POZITIE_PORTAL_FLOTA_VERDANT = [COORDONATA_PORTAL_AETHER, 0, COORDONATA_PORTAL_AETHER];
const POZITIE_PORTAL_VERDANT = [-COORDONATA_PORTAL_AETHER, 0, -COORDONATA_PORTAL_AETHER];
const POZITIE_PORTAL_VERDANT_NERIDIA = [COORDONATA_PORTAL_AETHER, 0, COORDONATA_PORTAL_AETHER];
const POZITIE_PORTAL_NERIDIA = [COORDONATA_PORTAL_AETHER, 0, COORDONATA_PORTAL_AETHER];
const POZITIE_PORTAL_NOCTIS_FRONTIERA_15 = [COORDONATA_PORTAL_AETHER, 0, COORDONATA_PORTAL_AETHER];
...
const POZITIE_PORTAL_FRONTIERA_18_SECTOR_45 = [-COORDONATA_PORTAL_AETHER, 0, -COORDONATA_PORTAL_AETHER];
...
function esteInZonaSiguraPortal(harta, pozitie) {
  const portaluri = harta === "aether"
    ...
    : harta === "noctis"
      ? [POZITIE_PORTAL_NOCTIS, POZITIE_PORTAL_KHARON_NOCTIS, POZITIE_PORTAL_NOCTIS_FRONTIERA_15]
      : harta === "kharon"
        ? [POZITIE_PORTAL_KHARON, POZITIE_PORTAL_FLOTA_KHARON]
        : harta === "flota"
          ? [POZITIE_PORTAL_FLOTA, POZITIE_PORTAL_FLOTA_VERDANT]
        : harta === "verdant"
          ? [POZITIE_PORTAL_VERDANT, POZITIE_PORTAL_VERDANT_NERIDIA]
        : harta === "neridia"
          ? [POZITIE_PORTAL_NERIDIA]
        : harta === "frontiera15"
        ...
        : harta === "frontiera18"
          ? [POZITIE_PORTAL_FRONTIERA_18, POZITIE_PORTAL_FRONTIERA_18_SECTOR_45]
        : SECTOARE_NOI[harta]
          ? SECTOARE_NOI[harta].urmator
            ? [POZITIE_PORTAL_SECTOR_INAPOI, POZITIE_PORTAL_SECTOR_INAINTE]
            : [POZITIE_PORTAL_SECTOR_INAPOI]
...
const POZITIE_INTRARE_FLOTA = [
  -COORDONATA_PORTAL_AETHER + DISTANTA_REAPARITIE_PORTAL,
  3.2,
  -COORDONATA_PORTAL_AETHER + DISTANTA_REAPARITIE_PORTAL,
];
const POZITIE_REVENIRE_KHARON_DIN_FLOTA = [...POZITIE_INTRARE_FLOTA];
const POZITIE_INTRARE_VERDANT = [...POZITIE_INTRARE_FLOTA];
const POZITIE_REVENIRE_FLOTA_DIN_VERDANT = [
  COORDONATA_PORTAL_AETHER - DISTANTA_REAPARITIE_PORTAL,
  3.2,
  COORDONATA_PORTAL_AETHER - DISTANTA_REAPARITIE_PORTAL,
];
const POZITIE_INTRARE_NERIDIA = [...POZITIE_REVENIRE_FLOTA_DIN_VERDANT];
const POZITIE_REVENIRE_VERDANT_DIN_NERIDIA = [...POZITIE_REVENIRE_FLOTA_DIN_VERDANT];
const POZITIE_INTRARE_FRONTIERA_15 = [
  -COORDONATA_PORTAL_AETHER + DISTANTA_REAPARITIE_PORTAL,
  3.2,
  COORDONATA_PORTAL_AETHER - DISTANTA_REAPARITIE_PORTAL,
];
const POZITIE_REVENIRE_NOCTIS_DIN_FRONTIERA_15 = [
  COORDONATA_PORTAL_AETHER - DISTANTA_REAPARITIE_PORTAL,
  3.2,
  COORDONATA_PORTAL_AETHER - DISTANTA_REAPARITIE_PORTAL,
];
const POZITIE_INTRARE_FRONTIERA_16 = [
  COORDONATA_PORTAL_AETHER - DISTANTA_REAPARITIE_PORTAL,
  3.2,
  COORDONATA_PORTAL_AETHER - DISTANTA_REAPARITIE_PORTAL,
];
const POZITIE_REVENIRE_FRONTIERA_15_DIN_FRONTIERA_16 = [
  -COORDONATA_PORTAL_AETHER + DISTANTA_REAPARITIE_PORTAL,
  3.2,
  -COORDONATA_PORTAL_AETHER + DISTANTA_REAPARITIE_PORTAL,
];
...
const POZITIE_INTRARE_SECTOR_NOU = [
  COORDONATA_PORTAL_AETHER - DISTANTA_REAPARITIE_PORTAL, 3.2,
  COORDONATA_PORTAL_AETHER - DISTANTA_REAPARITIE_PORTAL,
];
const POZITIE_REVENIRE_SECTOR_ANTERIOR = [
  -COORDONATA_PORTAL_AETHER + DISTANTA_REAPARITIE_PORTAL, 3.2,
  -COORDONATA_PORTAL_AETHER + DISTANTA_REAPARITIE_PORTAL,
];
...
export default function App() {
  ...
  const [semnalTransportPortalTertiar, setSemnalTransportPortalTertiar] = useState(0);
  ...
  useEffect(() => {
    ...
    function laApasareTasta(eveniment) {
      ...
      if (eveniment.code === "KeyJ" && !eveniment.repeat) {
        ...
        const portaluriDisponibile = hartaActiva === "aether"
          ...
          : hartaActiva === "noctis"
            ? [
                ...
                { pozitie: POZITIE_PORTAL_NOCTIS_FRONTIERA_15, tertiar: true },
              ]
            : hartaActiva === "kharon"
              ? [
                  { pozitie: POZITIE_PORTAL_KHARON, secundar: false },
                  { pozitie: POZITIE_PORTAL_FLOTA_KHARON, secundar: true },
                ]
              : hartaActiva === "flota"
                ? [
                    { pozitie: POZITIE_PORTAL_FLOTA, secundar: false },
                    { pozitie: POZITIE_PORTAL_FLOTA_VERDANT, secundar: true },
                  ]
                : hartaActiva === "verdant"
                  ? [
                      { pozitie: POZITIE_PORTAL_VERDANT, secundar: false },
                      { pozitie: POZITIE_PORTAL_VERDANT_NERIDIA, secundar: true },
                    ]
                  : hartaActiva === "neridia"
                    ? [{ pozitie: POZITIE_PORTAL_NERIDIA, secundar: false }]
                  : hartaActiva === "frontiera15"
                    ? [
                        { pozitie: POZITIE_PORTAL_FRONTIERA_15, secundar: false },
                  ...
                  : hartaActiva === "frontiera18"
                    ? [
                        ...
                        { pozitie: POZITIE_PORTAL_FRONTIERA_18_SECTOR_45, secundar: true },
                      ]
                  : SECTOARE_NOI[hartaActiva]
                    ? [
                        { pozitie: POZITIE_PORTAL_SECTOR_INAPOI, secundar: false },
                        ...(SECTOARE_NOI[hartaActiva].urmator
                          ? [{ pozitie: POZITIE_PORTAL_SECTOR_INAINTE, secundar: true }]
                          : []),
                      ]
        ...
        eveniment.preventDefault();
        if (portalApropiat.tertiar) {
          setSemnalTransportPortalTertiar((valoare) => valoare + 1);
        } else if (portalApropiat.secundar) {
  ...
  const transportaPrinPortalFlota = useCallback(() => {
    const intraInFlota = hartaActiva !== "flota";
    setPozitieTeleportare(
      intraInFlota ? POZITIE_INTRARE_FLOTA : POZITIE_REVENIRE_KHARON_DIN_FLOTA
    );
    setHartaActiva(intraInFlota ? "flota" : "kharon");
    setTintaJucator(null);
    setTintaLive(false);
    setTintaSelectata(null);
    setAtaca(false);
    setAmenintare(intraInFlota ? "sector Flota Cărămizie" : "sector Kharon Vesper");
    setSemnalTeleportare((valoare) => valoare + 1);
  }, [hartaActiva]);

  const transportaPrinPortalVerdant = useCallback(() => {
    const intraInVerdant = hartaActiva !== "verdant";
    setPozitieTeleportare(
      intraInVerdant ? POZITIE_INTRARE_VERDANT : POZITIE_REVENIRE_FLOTA_DIN_VERDANT
    );
    setHartaActiva(intraInVerdant ? "verdant" : "flota");
    setTintaJucator(null);
    setTintaLive(false);
    setTintaSelectata(null);
    setAtaca(false);
    setAmenintare(intraInVerdant ? "sector Verdant Rubra" : "sector Flota Cărămizie");
    setSemnalTeleportare((valoare) => valoare + 1);
  }, [hartaActiva]);

  const transportaPrinPortalNeridia = useCallback(() => {
    const intraInNeridia = hartaActiva !== "neridia";
    setPozitieTeleportare(
      intraInNeridia ? POZITIE_INTRARE_NERIDIA : POZITIE_REVENIRE_VERDANT_DIN_NERIDIA
    );
    setHartaActiva(intraInNeridia ? "neridia" : "verdant");
    setTintaJucator(null);
    setTintaLive(false);
    setTintaSelectata(null);
    setAtaca(false);
    setAmenintare(intraInNeridia ? "sector Neridia" : "sector Verdant Rubra");
    setSemnalTeleportare((valoare) => valoare + 1);
  }, [hartaActiva]);

  const transportaPrinPortalFrontiera15 = useCallback(() => {
    const intraInFrontiera = hartaActiva !== "frontiera15";
    setPozitieTeleportare(
      intraInFrontiera ? POZITIE_INTRARE_FRONTIERA_15 : POZITIE_REVENIRE_NOCTIS_DIN_FRONTIERA_15
    );
    setHartaActiva(intraInFrontiera ? "frontiera15" : "noctis");
    setTintaJucator(null);
    setTintaLive(false);
    setTintaSelectata(null);
    setAtaca(false);
    setAmenintare(intraInFrontiera ? "sector Frontiera 1-5" : "sector Ares Noctis");
    setSemnalTeleportare((valoare) => valoare + 1);
  }, [hartaActiva]);

  const transportaPrinPortalFrontiera16 = useCallback(() => {
    const intraInFrontiera16 = hartaActiva !== "frontiera16";
    setPozitieTeleportare(
      intraInFrontiera16 ? POZITIE_INTRARE_FRONTIERA_16 : POZITIE_REVENIRE_FRONTIERA_15_DIN_FRONTIERA_16
    );
    setHartaActiva(intraInFrontiera16 ? "frontiera16" : "frontiera15");
    setTintaJucator(null);
    setTintaLive(false);
    setTintaSelectata(null);
    setAtaca(false);
    setAmenintare(intraInFrontiera16 ? "sector Frontiera 1-6" : "sector Frontiera 1-5");
    setSemnalTeleportare((valoare) => valoare + 1);
  }, [hartaActiva]);
  ...
  const transportaSectorNou = useCallback((inainte) => {
    const destinatie = inainte
      ? hartaActiva === "frontiera18" ? "sector45" : SECTOARE_NOI[hartaActiva]?.urmator
      : SECTOARE_NOI[hartaActiva]?.anterior;
    if (!destinatie) return;
    setPozitieTeleportare(inainte ? POZITIE_INTRARE_SECTOR_NOU : POZITIE_REVENIRE_SECTOR_ANTERIOR);
    setHartaActiva(destinatie);
    setTintaJucator(null);
    setTintaLive(false);
    setTintaSelectata(null);
    setAtaca(false);
    setAmenintare(SECTOARE_NOI[destinatie]?.nume ?? "Frontiera 1-8");
    setSemnalTeleportare((valoare) => valoare + 1);
  }, [hartaActiva]);
  ...
  const esteFlota = hartaActiva === "flota";
  const esteVerdant = hartaActiva === "verdant";
  ...
  const corpuriHarta = sectorNou
    ...
    : esteNeridia
    ? CORPURI_HARTA_NERIDIA
    : esteVerdant
    ? CORPURI_HARTA_VERDANT
    : esteFlota
    ? CORPURI_HARTA_FLOTA
    : esteKharon
  ...
  return (
    <>
          ...
          <HartaSpatiala
            ...
            pozitiePortalAether={
              sectorNou
                ...
                ? POZITIE_PORTAL_NERIDIA
                : esteVerdant
                ? POZITIE_PORTAL_VERDANT
                : esteFlota
                ? POZITIE_PORTAL_FLOTA
                : esteKharon
            ...
            imaginePortalAether={
              sectorNou
                ...
                : esteNeridia
                ? "assets/portal-inel-algal.png"
                : esteVerdant
                ? "assets/portal-falia-clorofier.png"
                : esteFlota
                ? "assets/portal-ruptura-stacojie.png"
                : esteKharon || esteNoctis ? "assets/portal-hemofier.png" : undefined
            }
            temaPortalAether={sectorNou ? hartaActiva : esteFrontiera18 ? "frontiera18" : esteFrontiera17 ? "frontiera17" : esteFrontiera16 ? "frontiera16" : esteFrontiera15 ? "frontiera15" : esteNeridia ? "neridia" : esteVerdant ? "verdant" : esteFlota ? "flota" : esteKharon || esteNoctis ? "kharon" : "aether"}
            pozitiePortalSecundar={
              sectorNou?.urmator ? POZITIE_PORTAL_SECTOR_INAINTE : esteFrontiera18 ? POZITIE_PORTAL_FRONTIERA_18_SECTOR_45 : esteFrontiera17 ? POZITIE_PORTAL_FRONTIERA_17_FRONTIERA_18 : esteFrontiera16 ? POZITIE_PORTAL_FRONTIERA_16_FRONTIERA_17 : esteFrontiera15 ? POZITIE_PORTAL_FRONTIERA_15_FRONTIERA_16 : esteVerdant ? POZITIE_PORTAL_VERDANT_NERIDIA : esteFlota ? POZITIE_PORTAL_FLOTA_VERDANT : esteKharon ? POZITIE_PORTAL_FLOTA_KHARON : esteNoctis ? POZITIE_PORTAL_NOCTIS : esteAether ? POZITIE_PORTAL_NOCTIS_AETHER : null
            }
            imaginePortalSecundar={sectorNou?.urmator ? SECTOARE_NOI[sectorNou.urmator].portal : esteFrontiera18 ? SECTOARE_NOI.sector45.portal : esteFrontiera17 ? "assets/portal-frontiera-18.png" : esteFrontiera16 ? "assets/portal-frontiera-17.png" : esteFrontiera15 ? "assets/portal-frontiera-16.png" : esteVerdant ? "assets/portal-inel-algal.png" : esteFlota ? "assets/portal-falia-clorofier.png" : esteKharon ? "assets/portal-ruptura-stacojie.png" : "assets/portal-ares-noctis.png"}
            temaPortalSecundar={sectorNou?.urmator ? sectorNou.urmator : esteFrontiera18 ? "sector45" : esteFrontiera17 ? "frontiera18" : esteFrontiera16 ? "frontiera17" : esteFrontiera15 ? "frontiera16" : esteVerdant ? "neridia" : esteFlota ? "verdant" : esteKharon ? "flota" : "noctis"}
            ...
            onTransportSecundar={sectorNou?.urmator || esteFrontiera18 ? () => transportaSectorNou(true) : esteFrontiera17 ? transportaPrinPortalFrontiera18 : esteFrontiera16 ? transportaPrinPortalFrontiera17 : esteFrontiera15 ? transportaPrinPortalFrontiera16 : esteVerdant ? transportaPrinPortalNeridia : esteFlota ? transportaPrinPortalVerdant : esteKharon ? transportaPrinPortalFlota : transportaPrinPortalNoctis}
            ...
            semnalTransportTertiar={semnalTransportPortalTertiar}
          />
      ...
      <HartaMini
        marimeHarta={MARIME_HARTA}
        numeHarta={
          sectorNou ? sectorNou.nume : esteFrontiera18 ? "Frontiera 1-8" : esteFrontiera17 ? "Frontiera 1-7" : esteFrontiera16 ? "Frontiera 1-6" : esteFrontiera15 ? "Frontiera 1-5" : esteNeridia ? "Neridia" : esteVerdant ? "Verdant Rubra" : esteFlota ? "Flota Cărămizie" : esteKharon ? "Kharon Vesper" : esteNoctis ? "Ares Noctis" : esteAether ? "Aether" : "Sector standard"
        }
        ...
        etichetaPortal={
          sectorNou
            ? `Portal spre ${SECTOARE_NOI[sectorNou.anterior]?.nume ?? "Frontiera 1-8"}`
            : esteFrontiera18
            ...
            : esteNeridia
            ? "Inelul Algal spre Verdant Rubra"
            : esteVerdant
            ? "Falia Clorofier spre Flota Cărămizie"
            : esteFlota
            ? "Ruptura Stacojie spre Kharon Vesper"
            : esteKharon
        ...
        temaPortal={sectorNou ? hartaActiva : esteFrontiera18 ? "frontiera18" : esteFrontiera17 ? "frontiera17" : esteFrontiera16 ? "frontiera16" : esteFrontiera15 ? "frontiera15" : esteNeridia ? "neridia" : esteVerdant ? "verdant" : esteFlota ? "flota" : esteKharon || esteNoctis ? "kharon" : "aether"}
        pozitiePortalSecundar={
          sectorNou?.urmator ? POZITIE_PORTAL_SECTOR_INAINTE : esteFrontiera18 ? POZITIE_PORTAL_FRONTIERA_18_SECTOR_45 : esteFrontiera17 ? POZITIE_PORTAL_FRONTIERA_17_FRONTIERA_18 : esteFrontiera16 ? POZITIE_PORTAL_FRONTIERA_16_FRONTIERA_17 : esteFrontiera15 ? POZITIE_PORTAL_FRONTIERA_15_FRONTIERA_16 : esteVerdant ? POZITIE_PORTAL_VERDANT_NERIDIA : esteFlota ? POZITIE_PORTAL_FLOTA_VERDANT : esteKharon ? POZITIE_PORTAL_FLOTA_KHARON : esteNoctis ? POZITIE_PORTAL_NOCTIS : esteAether ? POZITIE_PORTAL_NOCTIS_AETHER : null
        }
        etichetaPortalSecundar={
          sectorNou?.urmator ? `Portal spre ${SECTOARE_NOI[sectorNou.urmator].nume}` : esteFrontiera18 ? "Portal spre Sector 4-5" : esteFrontiera17 ? "Portal spre Frontiera 1-8" : esteFrontiera16 ? "Portal spre Frontiera 1-7" : esteFrontiera15 ? "Portal spre Frontiera 1-6" : esteVerdant ? "Inelul Algal spre Neridia" : esteFlota ? "Falia Clorofier spre Verdant Rubra" : esteKharon ? "Ruptura Stacojie spre Flota Cărămizie" : esteNoctis ? "Portal spre Aether" : "Portal spre Ares Noctis"
        }
        temaPortalSecundar={sectorNou?.urmator ? sectorNou.urmator : esteFrontiera18 ? "sector45" : esteFrontiera17 ? "frontiera18" : esteFrontiera16 ? "frontiera17" : esteFrontiera15 ? "frontiera16" : esteVerdant ? "neridia" : esteFlota ? "verdant" : esteKharon ? "flota" : "noctis"}
        pozitiePortalTertiar={esteNoctis ? POZITIE_PORTAL_NOCTIS_FRONTIERA_15 : null}
